...
Dưới đây là bảng đã được dịch cột **Definition** (Định nghĩa) sang tiếng Việt:

| Loại loss | Định nghĩa | Phương trình |
|-----------|------------|--------------|
| \( L_1 \) loss | Tổng các giá trị tuyệt đối của chênh lệch giữa giá trị thực tế và giá trị dự đoán. | \[ \sum \lvert \text{giá trị thực} - \text{giá trị dự đoán} \rvert \] |
